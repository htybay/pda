...
import zxing.utils.BitmapUtils;
...
public final class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback {
	...
	public void handleDecode(Result rawResult, Bundle bundle) {
		...
		Intent intent = new Intent(ZXING_PDA_ACTION);
		intent.putExtra(ZXING_PDA_DATA_KEY, rawResult.getText());
		String activityName = getIntent().getStringExtra(START_ACTIVITY_NAME);
		intent.putExtra(START_ACTIVITY_NAME, activityName);
		sendBroadcast(intent);
        Log.e(TAG, "handleDecode: "+ rawResult.getText());
		this.finish();
	}
	//广播通知ACTION
	public static final String ZXING_PDA_ACTION = "com.android.zxing.pda.action";
	//广播通知KEY
