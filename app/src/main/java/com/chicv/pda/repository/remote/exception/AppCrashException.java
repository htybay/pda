package com.chicv.pda.repository.remote.exception;

import android.os.Environment;

import com.chicv.pda.utils.DateUtils;
import com.chicv.pda.utils.FileUtils;
...
public class AppCrashException implements Thread.UncaughtExceptionHandler {
    ...
    public static final String DIR_CRASH = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "pda";
